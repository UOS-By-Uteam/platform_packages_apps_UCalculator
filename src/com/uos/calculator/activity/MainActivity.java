package com.uos.calculator.activity;

import com.uos.calculator.R;
import com.uos.calculator.calc.StdCalculator;
import com.uos.calculator.exception.NumberOutOfRangeException;
import com.uos.calculator.thread.BlurTask;
import com.uos.calculator.thread.WbtBooterThread;
import com.uos.calculator.util.FileManager;
import com.uos.calculator.util.FontSizeCalculator;
import com.uos.calculator.util.MyGestureDetector;
import com.uos.calculator.util.ResultManager;
import com.uos.calculator.util.SystemUtil;
...
public class MainActivity extends Activity {
	...
	public void onResume() {
		...
		if (cacheWP.exists()) {
			...
			Bitmap oldWP = BitmapFactory.decodeFile(cacheWP.getPath(), options);
